...
;// CONCATENATED MODULE: ./src/js/functions/burger.js
...
;// CONCATENATED MODULE: ./src/js/functions/popup.js
...
;// CONCATENATED MODULE: ./src/js/functions/carousel.js
...
function changeToRight() {  
    const act = document.querySelector('.item-right');
...
console.log('Привет, слайдер еще в процессе доработк');
